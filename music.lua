...
function Music:new()
    ...
    self.sfx.merchantGreetingSFX = love.audio.newSource("SFX/MerchantGreeting.wav", "static")
    ...
    self.sfx.merchantPartingSFX = love.audio.newSource("SFX/MerchantParting.wav", "static")
    self.sfx.teleportCancelSFX = love.audio.newSource("SFX/TeleportCancel.mp3", "static")
    self.sfx.noPotionsVoiceSFX = love.audio.newSource("SFX/NoPotionsVoice.wav", "static")
    ...
    self.sfx.cantSellVoiceSFX = love.audio.newSource("SFX/CantSellVoice.wav", "static")
    self.sfx.notEnoughGoldSFX = love.audio.newSource("SFX/NotEnoughGold.wav", "static")
    ...
    self.sfx.teleportCastSFX = love.audio.newSource("SFX/TeleportCast.wav", "static")
    ...
    self.sfx.alreadyFullSFX = love.audio.newSource("SFX/AlreadyFull.wav", "static")
    ...
    self.voice["voiceStory17"] = love.audio.newSource("SFX/VoiceStory17.wav", "static")
